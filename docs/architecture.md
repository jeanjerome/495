...
- Inside `core`, only `engine` imports `agents` and `sandbox`. The rest of `core` (`models`,
  `reading`, `decide`, `scope`, `context`, `prompts`, `schemas`, `profile`, `catalogue`,
  `coverage`, `proposals`, `retro`, `lessons`, `stats`, `suite`, `diff`, `mutation`, `reach`,
